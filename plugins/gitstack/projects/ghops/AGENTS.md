...
- `projects/ghops/` is the maintained Python implementation behind the shipped runtime artifact at `plugins/gitstack/scripts/ghops`.
- Normal runtime usage must stay on `plugins/gitstack/scripts/ghops`.
- The shipped artifact is a Python executable zipapp, not a hand-written wrapper.

## Runtime Surface

- Shipped artifact: `plugins/gitstack/scripts/ghops`
- Version check: `plugins/gitstack/scripts/ghops --version`
- Readiness check: `plugins/gitstack/scripts/ghops --json doctor`
...
- `python3 -m py_compile plugins/gitstack/projects/ghops/src/ghops/*.py plugins/gitstack/projects/ghops/tests/test_ghops.py`
- `python3 -m unittest discover -s plugins/gitstack/projects/ghops/tests -p 'test_*.py'`
- `plugins/gitstack/scripts/ghops --help`
- `plugins/gitstack/scripts/ghops --version`
- `plugins/gitstack/scripts/ghops --json doctor`

## Rebuild

- Rebuild the shipped artifact with:
  - `python3 -m zipapp plugins/gitstack/projects/ghops/src -o plugins/gitstack/scripts/ghops -m 'ghops:main' -p '/usr/bin/env python3'`
- After rebuilding, restore the executable bit with:
  - `chmod +x plugins/gitstack/scripts/ghops`
