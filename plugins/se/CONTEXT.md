...
and Implement skills have distinct runtime contracts, while `AGENTS.md`
...
Every delivery invocation ends with a [closeout](skills/deliver-features/references/closeout.md)
