...
| --- | --- |
| Implement, Adversarial Review, Review PR, Grilling Session, Learn, Idea, Audit | Perform their work in the executing session/task; create no tasks or subagents. |
