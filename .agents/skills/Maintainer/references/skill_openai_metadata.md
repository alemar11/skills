...
2. Create a reusable skill directory under `skills/` with a stable lowercase name (or `.agents/skills/` for maintainer skills).
...
6. Update repo-level `README.md` and any installer guidance that lists this skill.
